    ...
    return <div className="flex flex-row gap-2">
        <div className="flex flex-col gap-2">
            <div>
                ...
                <input value={customEmail.subject} className="text-black px-2 rounded-md w-[25rem]" type="text" placeholder="e.g. 'AI'" />
            </div>
            <div>
                <h3 className="text-lg font-bold">Topic</h3>
                <textarea value={customEmail.topic} className="text-black px-2 rounded-md w-[25rem] h-[10rem]" placeholder="e.g. 'AI'" />
            </div>
        </div>
        <div className="flex flex-col gap-2">
            <div>
                <h3 className="text-lg font-bold">Send to</h3>
                <input value={customEmail.sendTo} className="text-black px-2 rounded-md" type="text" placeholder="email@example.com" />
            </div>
            <div>
                ...
                {customEmail.schedule.map((day, index) => (
                    <div key={index} className="flex flex-row gap-8">
                        ...
                        <input checked={day === 1} className="text-black px-2 rounded-md" type="checkbox" />
                    </div>
                ))}
            </div>
        </div>
